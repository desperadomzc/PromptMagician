...
import {Input, Slider, Modal, Select, Image, message, Flex} from "antd";
import {useDispatch, useSelector} from "react-redux";
import {Dispatch, RootState} from "../../store";
import {LoadingOutlined, PlusOutlined} from '@ant-design/icons';
import {image} from "d3";
import {getProcessedImage} from "../../services";

const {TextArea} = Input;

const ParameterConfigration = () => {
    const [currentImageUrl, setCurrentImageUrl] = useState<string>("");
    const [currentProcessedImageStr, setCurrentProcessedImageStr] = useState<string>();
    ...
    const modelSelectOnchange = (e: string) => {
        ...
        updateProcessedImage(e, currentImageUrl)
    };

    const imageUrlOnChange = (e: ChangeEvent<HTMLInputElement>) => {
        setCurrentImageUrl(e.target.value);
        updateProcessedImage(currentSelectModel, e.target.value)
    };

    const updateProcessedImage = (select_model: string, image_url: string) => {
        setCurrentProcessedImageStr('')
        getProcessedImage([select_model, image_url]).then(res => {
            setCurrentProcessedImageStr('data:image/png;base64,' + res);
        })
    }
    ...
    const imageField = (
        <Flex gap="middle">
            <div className={styles['image_field_title']}>Origin Image</div>
            <Image
            ...
            />
            <div className={styles['image_field_title']}>{currentSelectModel} Image</div>
            <Image
                className={styles["select-model-image-img"]}
                src={currentProcessedImageStr}
                fallback="data:image/png;base64,"
            />
        </Flex>
    )
